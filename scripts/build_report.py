...
needs = [
    "Section 2, crypto Minimum Variance Sharpe 1.011 vs equity funds: the claim that this is confounded by the different sample window (1,208 vs 753 days) is the draft's reasoning; confirm you agree the comparison is not like-for-like.",
